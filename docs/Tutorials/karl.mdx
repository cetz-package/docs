...
scale(3)
grid((-0.5, -0.5), (1, 1))
line((-0.5, 0), (1, 0), mark: (end: ">"))
line((0, -0.5), (0, 1), mark: (end: ">"))
arc((0, 1), start: 90deg, delta: -120deg)
arc(
  (3mm, 0),
  start: 0deg,
...
If Karl had used the value `(start: ">")` instead of `(end: ">")`, arrow tips would have been put at the beginning of the path. The value `(start: ">", end: ">")` or `(symbol: ">")` puts arrow tips at both ends of the path.
